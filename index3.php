...
<p align="left"> Написать функцию с параметрами (“строка”, “положительное_число”), которая выводит строку змейкой в квадрат с длиной стороны “положительное_число”.
	...
	<p align="left"> Введенная размерность массива: <?php print_r($_REQUEST['arraySize']); ?>
	
	<p align="left"> Введенная строка-заполнитель: <?php print_r($_REQUEST['arrayContentString']); ?>
